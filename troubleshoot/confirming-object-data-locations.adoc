...
---
= Confirmez l'emplacement des données d'objet dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:object_lookup.png["Page recherche d'objets"]
...
+
image:object_lookup_results.png["Résultats de la recherche d'objets"]
