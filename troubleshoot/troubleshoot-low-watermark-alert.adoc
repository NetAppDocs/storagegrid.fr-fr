...
---
= Résoudre l'alerte de remplacement de filigrane dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:nodes_page_object_data_used_with_alert.png["Page nœuds affichant les données d'objet utilisées pour 3 SNS"]
...
.. Faites défiler vers le bas jusqu'au tableau des magasins d'objets.
