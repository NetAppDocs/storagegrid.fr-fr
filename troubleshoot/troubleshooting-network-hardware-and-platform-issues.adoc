...
---
= Résolvez les problèmes de réseau, de matériel et de plateforme dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Créez des interfaces réseau virtuelles distinctes pour le système d'exploitation hôte Linux. L'utilisation des mêmes interfaces réseau pour le système d'exploitation hôte Linux et le conteneur StorageGRID pourrait rendre le système d'exploitation hôte inaccessible.
