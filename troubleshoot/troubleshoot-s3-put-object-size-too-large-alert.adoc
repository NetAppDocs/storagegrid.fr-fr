...
---
= Résoudre l'alerte « Taille d'objet S3 PUT trop importante » dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
.. Accédez à *Support* > *Outils* > *Collecte de journaux*.  Collectez les journaux d’application pour le nœud de stockage dans l’alerte.  Précisez 15 minutes avant et après l'alerte. link:../monitor/collecting-log-files-and-system-data.html["Collecte de fichiers journaux et de données système"] .
