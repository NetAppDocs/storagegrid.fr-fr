...
---
= Résolvez l'alerte relative aux objets potentiellement perdus dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
L'assistance technique pourrait vous demander de vérifier si une procédure de récupération de stockage est en cours. Consultez :
