...
---
= Découvrez les défaillances du stockage d'objets pour les volumes de stockage dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:nodes_page_storage_nodes_storage_tables.png["Nœuds page tables de stockage de nœuds"]
