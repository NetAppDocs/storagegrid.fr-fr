...
summary: 'Lorsqu"un client Swift émet une opération HEAD, une demande est formulée pour vérifier l"existence d"un compte, d"un conteneur ou d"un objet et pour extraire toutes les métadonnées pertinentes. Ce message est émis par le serveur si l"opération a réussi.' 
---
= WHEA: TÊTE SWIFT
:allow-uri-read: 
:icons: font
...
[role="lead"]
Lorsqu'un client Swift émet une opération HEAD, une demande est formulée pour vérifier l'existence d'un compte, d'un conteneur ou d'un objet et pour extraire toutes les métadonnées pertinentes. Ce message est émis par le serveur si l'opération a réussi.
...
Code de résultat
 a| 
Résultat du fonctionnement de la TÊTE. Le résultat est toujours :
