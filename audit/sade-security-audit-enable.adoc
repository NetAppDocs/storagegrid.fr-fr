...
summary: 'Ce message indique que le service d"origine (ID du nœud) a rétabli la journalisation des messages d"audit. StorageGRID collecte et distribue à nouveau les messages d"audit.' 
---
