...
image:audit_message_flow.gif["Schéma qui résume le flux des messages d'audit à travers les relais"]
...
image:audit_message_retention.gif["Schéma qui résume la réception du message d'audit à l'AMS"]
