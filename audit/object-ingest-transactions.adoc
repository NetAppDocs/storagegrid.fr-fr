...
Tous les messages d’audit générés lors d’une transaction d’ingestion ne sont pas répertoriés dans le tableau suivant.  Seuls les messages nécessaires au suivi de la transaction d'ingestion sont inclus.
...
----
Le champ PATH inclut les informations sur le bucket S3 et la clé.
