...
summary: 'Les messages d"audit appartenant à la catégorie d"audit du système sont utilisés pour les événements liés au système d"audit lui-même, aux États des nœuds de la grille, à l"activité des tâches à l"échelle du système (tâches de la grille) et aux opérations de sauvegarde des services.' 
---
