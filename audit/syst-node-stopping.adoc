...
summary: 'Lorsqu"un service est arrêté correctement, ce message est généré pour indiquer que l"arrêt a été demandé et que le service a entamé sa séquence d"arrêt. SYST peut être utilisé pour déterminer si l"arrêt a été demandé, avant que le service ne soit redémarré (contrairement à SYSD, qui est généralement envoyé après le redémarrage du service).' 
---
