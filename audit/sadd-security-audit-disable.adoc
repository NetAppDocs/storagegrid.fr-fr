...
summary: 'Ce message indique que le service d"origine (ID du nœud) a désactivé la journalisation des messages d"audit. StorageGRID ne collecte ni ne transmet plus de messages d"audit.' 
---
