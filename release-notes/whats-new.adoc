...
summary: 'StorageGRID 12.0 étend la capacité de stockage d"objets, améliore la prise en charge des charges de travail d"IA/ML, renforce la fédération de grilles, simplifie la gestion du système et améliore la sécurité sur l"ensemble de la plateforme.' 
---
...
[role="lead"]
StorageGRID 12.0 étend la capacité de stockage d'objets, améliore la prise en charge des charges de travail d'IA/ML, renforce la fédération de grilles, simplifie la gestion du système et améliore la sécurité sur l'ensemble de la plateforme.

Pour plus de détails sur les problèmes résolus et les problèmes connus dans les versions récentes de StorageGRID 12.0, consultez  https://library.netapp.com/ecm/ecm_download_file/ECMLP3351267["Notes de version de StorageGRID 12.0"^]. Vous devez vous connecter avec votre compte NetApp ou créer un compte pour accéder aux notes de version.
