...
sidebar: sidebar 
keywords:  
summary: Découvrez les fonctionnalités et capacités qui ont été supprimées ou rendues obsolètes dans StorageGRID 12.0. Avant de procéder à la mise à niveau, vérifiez si les fonctionnalités supprimées ou obsolètes affectent vos applications clientes ou la configuration de votre grille. 
---
...
[role="lead"]
Découvrez les fonctionnalités et capacités qui ont été supprimées ou rendues obsolètes dans StorageGRID 12.0. Avant de procéder à la mise à niveau, vérifiez si les fonctionnalités supprimées ou obsolètes affectent vos applications clientes ou la configuration de votre grille.
