...
summary: 'StorageGRID 12.0 utilise la version 4 de l"API de gestion des locataires. La version 4 remplace la version 3. Cependant, les versions 1, 2 et 3 restent prises en charge.' 
---
