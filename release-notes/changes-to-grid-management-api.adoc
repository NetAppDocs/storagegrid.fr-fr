...
summary: 'StorageGRID 12.0 utilise la version 4 de l"API de gestion de la grille. La version 4 remplace la version 3. Cependant, les versions 1, 2 et 3 restent prises en charge.' 
---
