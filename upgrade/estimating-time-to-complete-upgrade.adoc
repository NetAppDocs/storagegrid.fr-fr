...
---
= Estimez le temps nécessaire pour effectuer une mise à niveau de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== Exemple : Temps estimé pour la mise à niveau vers StorageGRID 12.1
...
+
Vous devriez prévoir jusqu'à 18 heures pour terminer la mise à niveau de votre système vers StorageGRID 12.1.0.
