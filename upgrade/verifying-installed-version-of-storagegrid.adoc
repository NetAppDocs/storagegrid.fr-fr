...
---
= Vérifiez la version installée de StorageGRID avant la mise à niveau
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
L'exemple suivant illustre les étapes de mise à niveau de StorageGRID de la version 11.9 à la version 12.0 en préparation d'une mise à niveau vers StorageGRID 12.1.
