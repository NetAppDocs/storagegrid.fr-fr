...
summary: 'Vous pouvez utiliser l"outil VMware OVF pour automatiser le déploiement des nœuds de grille dans StorageGRID. Vous pouvez également automatiser la configuration de StorageGRID.' 
---
= Automatisez le déploiement des nœuds de grille dans StorageGRID avec VMware vSphere
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
