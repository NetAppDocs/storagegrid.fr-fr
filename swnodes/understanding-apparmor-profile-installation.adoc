...
----
* Désactivez complètement AppArmor. Pour Ubuntu 9.10 ou version ultérieure, suivez les instructions dans le https://help.ubuntu.com/community["Communauté en ligne Ubuntu"]. La désactivation complète de AppArmor peut ne pas être possible sur les versions plus récentes d'Ubuntu.
+
