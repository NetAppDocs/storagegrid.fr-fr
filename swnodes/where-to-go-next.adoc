...
---
= Découvrez les étapes obligatoires et facultatives après l'installation de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* (VMware uniquement) Configurez VMware vSphere Hypervisor pour le redémarrage automatique.
+
