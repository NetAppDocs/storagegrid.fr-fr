...
---
= Informations et documents requis pour StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
--
Consultez link:../network/index.html["Instructions de mise en réseau"].
...
+
--
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3373065["Notes de mise à jour"^]. Vous devez vous connecter avec votre compte NetApp ou en créer un pour accéder aux notes de version.
