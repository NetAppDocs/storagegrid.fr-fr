...
---
= Valider la configuration StorageGRID sous Linux
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:rhel_node_configuration_file_output.gif["Cette image est expliquée par le texte qui l'entoure."]
...
image:rhel_node_configuration_file_output_with_errors.gif["Cette image est expliquée par le texte qui l'entoure."]
