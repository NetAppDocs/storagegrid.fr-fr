...
summary: 'Vous pouvez automatiser l"installation du service hôte StorageGRID et la configuration des nœuds de grille sous Linux.' 
---
= Automatisez l'installation du service hôte StorageGRID et la configuration des nœuds de la grille sous Linux
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
