...
* Si vous utilisez des hôtes virtuels, vous avez lu avant de configurer le <<mac_address_cloning_ubuntu,Considérations et recommandations relatives au clonage d'adresses MAC>>réseau hôte.
