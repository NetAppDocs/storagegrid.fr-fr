...
summary: 'Le pare-feu interne de StorageGRID autorise uniquement les connexions entrantes vers certains ports du réseau Grid, à l’exception des ports 22, 80, 123 et 443 (voir les informations relatives aux communications externes). Les connexions sont également acceptées sur les ports définis par les points de terminaison de l’équilibreur de charge.' 
---
...
Appliances
 a| 
Nœud d'administration principal et nœud d'administration non principal
 a| 
