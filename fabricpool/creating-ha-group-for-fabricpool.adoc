...
summary: 'Lors de la configuration de StorageGRID pour une utilisation avec FabricPool, vous pouvez éventuellement créer un ou plusieurs groupes à haute disponibilité (HA).' 
---
= Créez un groupe à haute disponibilité (HA) pour FabricPool dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
