...
---
= Créez un compte locataire pour FabricPool dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. Vous pouvez également sélectionner *Utiliser une connexion de fédération de grille* pour permettre au locataire d'utiliser une link:../admin/grid-federation-overview.html["connexion de fédération de grille"] pour la synchronisation des comptes et la réplication inter-grilles. Ensuite, sélectionnez la connexion de fédération de grille à utiliser.
