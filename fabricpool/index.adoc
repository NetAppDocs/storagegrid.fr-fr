...
[role="quick-margin-para"]
Vous pouvez éventuellement configurer link:../admin/using-identity-federation.html["fédération des identités"] et link:../admin/how-sso-works.html["authentification unique"].
