...
---
= Ajoutez ou mettez à jour des sous-réseaux au réseau Grid pour l'extension dans StorageGRID.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Par exemple, n'utilisez pas les plages de sous-réseaux suivantes pour le réseau Grid, le réseau d'administration ou le réseau client d'un nœud :
