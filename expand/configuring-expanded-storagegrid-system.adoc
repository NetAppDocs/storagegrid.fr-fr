...
---
= Configurez les nœuds et sites nouvellement ajoutés dans StorageGRID.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
.. Si l’authentification unique (SSO) est activée pour votre système StorageGRID, créez une approbation de partie de confiance pour le nouveau nœud d’administration. Vous ne pouvez pas vous connecter à ce nœud tant que vous n’avez pas créé cette approbation de partie de confiance. Reportez-vous à la configuration de l’authentification unique (SSO) à l’aide de link:../admin/learn-about-setting-up-sso-oidc.html["OIDC"] ou link:../admin/learn-about-setting-up-sso-saml.html["SAML"].
