...
---
= Ajoutez des volumes à connexion directe ou SAN aux nœuds de stockage Linux dans StorageGRID
:allow-uri-read: 
:imagesdir: ../media/
...
.Avant de commencer
* Vous avez accès à lalink:../swnodes/index.html["instructions pour l'installation de StorageGRID"] pour votre plateforme Linux.
