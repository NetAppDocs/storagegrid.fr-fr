...
---
= Préparez-vous à étendre votre système StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:../swnodes/index.html["Instructions d'installation pour votre plate-forme"]
...
. Si vous étendez un système RHEL, sélectionnez les fichiers appropriés.
