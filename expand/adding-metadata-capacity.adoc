...
---
= Instructions pour l'ajout de capacité de métadonnées dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:metadata_space_after_expansion.png["Diagramme des métadonnées redistribuées après l'ajout de deux nœuds de stockage"]
