...
---
= Supprimer les références ILM à un site dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
** Pour supprimer une règle, sélectionnez l'icône de la corbeille image:icon_trash_can.png["Corbeille des icônes"] et sélectionnez *OK*.
+
