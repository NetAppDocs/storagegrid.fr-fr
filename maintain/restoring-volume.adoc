...
---
= Restaurez les données d'objet à l'aide de StorageGRID Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Vous avez confirmé que le nœud de stockage sur lequel vous restaurez des objets a un état de connexion *Connecté* image:icon_alert_green_checkmark.png["icône alerte verte coche"] dans l’onglet *Nœuds* > *Vue d’ensemble* du Grid Manager.
