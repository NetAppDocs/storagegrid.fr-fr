...
---
= Remplacez un nœud VMware dans StorageGRID par un nœud de récupération
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Nœuds d'administration
 a| 
link:recovering-from-admin-node-failures.html["Récupération du nœud d'administration principal ou non principal dans StorageGRID"]
