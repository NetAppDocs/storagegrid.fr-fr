...
---
= Ajouter ou modifier les listes de sous-réseaux sur le réseau d'administration dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:change_ip_tool_aesl_sample_input.gif["modifier l'outil ip, exemple aesl"]
...
+
image:change_ip_tool_aesl_sample_output.png["capture d'écran décrite par le texte environnant"]
