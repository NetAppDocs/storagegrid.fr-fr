...
---
= Vérifiez l'état du système avant d'appliquer un correctif StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Les nœuds connectés ont des coches vertes image:icon_alert_green_checkmark.png["icône alerte verte coche"] sur la page Nœuds.
