...
---
= Ajouter ou mettre à jour les noms d'affichage StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Pour supprimer les éléments que vous ne souhaitez pas renommer, sélectionnez image:icon-x-to-remove.png["Icône X."] dans la colonne *Supprimer de la liste*.
+
...
. Sélectionnez image:icon-x-to-remove.png["Icône X."] pour supprimer les éléments que vous ne souhaitez pas renommer avec cet outil.
+
Par exemple, supposons que vous souhaitiez renommer tous les nœuds contenant la chaîne `Data-Center-1`, mais que vous ne vouliez pas renommer le `Data-Center-1` site lui-même. Sélectionnez image:icon-x-to-remove.png["Icône X."] pour retirer le site de l’aperçu du renommage.

+
image:rename-bulk-rename-tool.png["Renommer l'outil en bloc avant"]
...
+
image:rename-bulk-rename-tool-after.png["Outil de renommage en bloc après"]
...
. Apportez les modifications supplémentaires nécessaires ou sélectionnez image:icon-x-to-remove.png["Icône X."] pour supprimer les éléments que vous ne souhaitez pas renommer.
...
--
.. Copiez le nom système d'origine de chaque élément et collez-le dans le champ *Nom d'affichage*, ou sélectionnez image:icon-x-to-remove.png["Icône X."] pour supprimer les éléments que vous ne souhaitez pas rétablir.
+
...
.. Vérifiez que chaque entrée du champ *Nom d'affichage* correspond au nom du champ *Nom système*. Apportez les modifications nécessaires ou sélectionnez image:icon-x-to-remove.png["Icône X."] pour supprimer les éléments que vous ne souhaitez pas rétablir.
+
Pour rétablir un nom d'affichage, le nom du système doit apparaître dans le champ *Nom d'affichage*, mais le nom n'est pas sensible à la casse.
