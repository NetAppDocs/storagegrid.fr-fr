...
---
= Surveillez l'installation de l'appliance de services StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Étapes
. Pour suivre la progression de l'installation, sélectionnez *Monitor installation* dans la barre de menu.
+
