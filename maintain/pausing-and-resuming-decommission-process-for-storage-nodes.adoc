...
---
= Mettre en pause et reprendre le processus de mise hors service des nœuds de stockage StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:decommission_nodes_procedure_paused.png["Procédure mise hors service des nœuds mise en pause"]
