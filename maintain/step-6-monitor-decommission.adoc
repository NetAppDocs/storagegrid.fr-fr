...
summary: 'À partir de l"étape 6 (Monitor Decommission) de l"assistant de page site de désaffection, vous pouvez surveiller la progression du site à mesure que celui-ci est supprimé.' 
---
= Surveillez la progression de la mise hors service du site dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:decommission_site_step_6_recovery_package.png["Paquet de récupération de l'étape 6 de déclassement du site"]
...
+
image:decommission_site_step_6_data_movement.png["Désaffectez le déplacement des données étape 6 du site"]
...
+
image:decommission_site_step_6_storage_node.png["Désaffectation du nœud de stockage étape 6 du site"]
...
+
image:decommission_site_step_6_repair_cassandra.png["Désaffectez le site étape 6 réparation Cassandra"]
...
+
image:decommission_site_step_6_remove_configuration.png["Désaffectez le site étape 6 Supprimer la configuration"]
...
+
image:decommission_site_success_message.png["Message de réussite du site de désaffectation"]
