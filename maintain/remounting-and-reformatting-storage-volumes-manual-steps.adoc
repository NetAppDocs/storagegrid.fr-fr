...
+
** Dans la plupart des cas, vous devriez link:../maintain/restoring-object-data-to-storage-volume.html["Restaurez les données d'objet à l'aide de Grid Manager"]. Répondez `y` pour utiliser le Gestionnaire de grille.
