...
---
= Effectuez des étapes de récupération supplémentaires du nœud StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Nœud d'administration principal
 a| 
* link:selecting-start-recovery-to-configure-primary-admin-node.html["Sélectionnez Démarrer la récupération pour configurer le nœud Admin principal"]
* link:selecting-start-recovery-to-configure-non-primary-admin-node.html["Récupérez le nœud d'administration principal à l'aide d'un nœud d'administration non principal"]
