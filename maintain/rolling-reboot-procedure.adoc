...
---
= Effectuez un redémarrage progressif de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
TIP: Vous ne pouvez pas redémarrer un nœud s'il est déconnecté du grid. Les cases à cocher sont désactivées pour les nœuds avec ces icônes : image:icon_alarm_gray_administratively_down.png["icône de point d'interrogation grise"] ou image:icon_alarm_blue_unknown.png["icône bleue du point d'interrogation"].
