...
---
= Appliquer un correctif dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:software_update_landing.png["Page d'accueil de mise à jour de logiciels"]
...
+
image:hotfix_choose_file.png["Correctif Choisissez fichier"]
...
+
.. Les validations du correctif sont exécutées, y compris la vérification de la signature du code.
+
...
+
image:hotfix_progress_table.png["Tableau de progression du correctif"]
...
+
image:approve_all_progresstable.png["Progression du correctif avec le bouton Supprimer"]
