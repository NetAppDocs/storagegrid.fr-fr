...
.Avant de commencer
* Vous avez confirmé que le nœud de stockage récupéré a un état de connexion *Connecté* image:icon_alert_green_checkmark.png["icône alerte verte coche"] sur l’onglet *Nœuds* > *Vue d’ensemble* dans le Grid Manager.
