...
summary: 'Restaurez le journal des audits sur le nœud d"administration principal récupéré à l"aide d"un nœud d"administration non principal.' 
---
= Restaurez le journal des audits StorageGRID sur un nœud d'administration principal récupéré
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
