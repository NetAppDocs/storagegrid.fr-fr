...
---
= Mettre hors service les nœuds StorageGRID connectés
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Tous les nœuds de la grille ont un état normal (vert) image:icon_alert_green_checkmark.png["icône de coche verte"]. Si vous voyez l'une de ces icônes dans la colonne *État*, vous devez essayer de résoudre le problème :
+
[cols="1a,1a,3a"]
|===
| Icône | Couleur | Gravité 
 ...
 a| 
image:icon_alarm_yellow_notice.gif["icône carrée jaune"]
 a| 
Jaune
 a| 
Avertissement
 ...
 a| 
image:icon_alert_yellow_minor.png["icône orange clair en forme de losange"]
 a| 
Orange clair
 a| 
Mineur
 ...
 a| 
image:icon_alert_orange_major.png["icône losange orange foncé"]
 a| 
Orange foncé
 a| 
Majeur
 ...
 a| 
image:icon_alert_red_critical.png["icône x rouge"]
 a| 
Rouge
 a| 
Primordial
