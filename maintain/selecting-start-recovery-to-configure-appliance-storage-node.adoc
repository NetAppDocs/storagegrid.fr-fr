...
+
image:recovery_reset_button.gif["capture d'écran indiquant l'étape en attente des étapes manuelles"]
...
+
image:recovery_reset_warning.gif["capture d'écran affichant la boîte de dialogue d'avertissement de réinitialisation de la restauration"]
