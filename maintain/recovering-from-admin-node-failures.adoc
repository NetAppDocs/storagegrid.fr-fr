...
---
= Récupération du nœud d'administration principal ou non principal dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Choix
* link:recovering-from-primary-admin-node-failures.html["Récupérez le nœud d'administration principal en utilisant le même nœud d'administration principal"]
* link:recovering-from-primary-admin-node-failures-using-npan.html["Récupérez après des défaillances du nœud d'administration principal à l'aide d'un nœud d'administration non principal"]
