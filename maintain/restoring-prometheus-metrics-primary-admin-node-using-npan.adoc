...
summary: 'Restaurez les métriques Prometheus lors de la récupération d"un nœud d"administration principal à l"aide d"un nœud d"administration non principal.' 
---
= Restaurez les métriques Prometheus lors de la récupération d'un nœud d'administration principal StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
