...
---
= Ajouter ou modifier les listes de sous-réseaux sur le réseau Grid dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:change_ip_tool_gnsl_sample_input.gif["capture d'écran décrite par le texte environnant"]
...
+
image:change_ip_tool_gnsl_sample_output.gif["capture d'écran décrite par le texte environnant"]
