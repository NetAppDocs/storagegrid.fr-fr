...
summary: 'Restaurez la base de données du nœud d"administration lors de la récupération d"un nœud d"administration principal en utilisant un nœud d"administration non principal.' 
---
= Restaurez la base de données StorageGRID Admin Node lors de la récupération du nœud d'administration principal
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. Ajoutez la clé privée SSH à l'agent SSH. Saisissez : `ssh-add`
...
.. Lorsque vous n'avez plus besoin d'un accès sans mot de passe à d'autres serveurs, supprimez la clé privée de l'agent SSH. Saisissez : `ssh-add -D`
