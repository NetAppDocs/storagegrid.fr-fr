...
+
La page Téléchargement du logiciel StorageGRID s'affiche.
...
+
Si le bouton *Démarrer l'installation* n'est pas activé, vous devrez peut-être modifier la configuration du réseau ou les paramètres du port. Reportez-vous aux instructions d'entretien de votre appareil.
