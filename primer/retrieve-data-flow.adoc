...
image:retrieve_data_flow.png["Récupérer"]
...
. Le service LDR source renvoie les données de l'objet récupéré au service LDR interrogé, et le système renvoie l'objet à l'application cliente.
