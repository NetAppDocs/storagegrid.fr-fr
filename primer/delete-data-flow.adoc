...
Voir link:../ilm/how-objects-and-delete-markers-are-deleted.html["Comment les objets et les marqueurs de suppression sont supprimés"] pour plus d'informations.
...
image:delete_data_flow.png["Le client supprime le flux de données"]
...
image:automatic_deletion_data_flow.png["Flux de données de suppression automatique"]
