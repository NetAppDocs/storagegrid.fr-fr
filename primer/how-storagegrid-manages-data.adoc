...
image:object_conceptual_drawing.png["Objet"]
...
image:ilm_replication_make_2_copies.png["Règle de création de 2 copies"]
...
image:ec_three_sites_4_plus_2.png["Code d'effacement trois sites 4 plus 2"]
