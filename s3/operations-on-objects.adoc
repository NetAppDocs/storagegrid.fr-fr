...
* StorageGRID link:consistency.html["valeurs de cohérence"]sont pris en charge par toutes les opérations sur les objets, à l'exception des opérations suivantes :
+
** GetObjectAcl
** `OPTIONS /`
** PutObjectLegalHold
