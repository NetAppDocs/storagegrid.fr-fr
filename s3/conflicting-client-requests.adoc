...
summary: Les requêtes conflictuelles des clients, telles que deux clients écrivant sur la même clé, sont résolues selon le principe du dernier arrivé, dernier servi. 
---
