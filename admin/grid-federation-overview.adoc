...
image:grid-federation-workflow.png["Flux de travail de connexion de fédération de grille"]
...
+
Pour plus de détails sur les exigences de version, consultez  https://library.netapp.com/ecm/ecm_download_file/ECMLP3351267["Notes de mise à jour"^]. Vous devez vous connecter avec votre compte NetApp ou créer un compte pour accéder aux notes de version.
...
image:grid-federation-certificates.png["Certificats de fédération de grille"]
