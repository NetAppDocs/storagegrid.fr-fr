...
summary: Vous pouvez utiliser la fédération de grilles pour synchroniser les locataires et répliquer leurs objets entre plusieurs systèmes StorageGRID à des fins de reprise après sinistre. 
---
...
[role="lead"]
Vous pouvez utiliser la fédération de grilles pour synchroniser les locataires et répliquer leurs objets entre plusieurs systèmes StorageGRID à des fins de reprise après sinistre.
...
image:grid_federation_workflow.png["Flux de travail de connexion de fédération de grille"]
...
+
Pour plus de détails sur les exigences de version, consultez  https://library.netapp.com/ecm/ecm_download_file/ECMLP3373065["Notes de mise à jour"^]. Vous devez vous connecter avec votre compte NetApp ou en créer un pour accéder aux notes de version.
...
* Au moins une connexion de fédération de grille doit exister avant que vous puissiez utiliser link:grid-federation-what-is-account-sync.html["synchronisation des comptes"] ou link:grid-federation-what-is-cross-grid-replication.html["réplication entre plusieurs grilles"].
...
image:grid_federation_certificates.png["Certificats de fédération de grille"]
