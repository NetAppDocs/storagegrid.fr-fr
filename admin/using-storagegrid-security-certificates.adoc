...
*** link:creating-relying-party-trusts-in-ad-fs-saml.html#create-a-relying-party-trust-manually["Spécifiez manuellement un certificat SSO pour une confiance de partie utilisatrice"]
