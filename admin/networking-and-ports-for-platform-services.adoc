...
* Un noeud final Web externe ou hébergé localement qui prend en charge les requêtes HTTP POST-notification.
+
Ce noeud final peut être hébergé sur divers serveurs Web, infrastructures ou outils Data Processing tels que Fluentd.
