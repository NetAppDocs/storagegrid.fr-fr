...
summary: 'Avant d"activer l"authentification unique (SSO), vous devez confirmer qu"au moins un utilisateur fédéré peut se connecter au Grid Manager et au tenant Manager pour tout compte de tenant existant.' 
---
