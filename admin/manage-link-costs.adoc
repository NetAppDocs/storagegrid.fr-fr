...
image:link_costs.gif["Schéma conceptuel des coûts de liaison entre les centres de données"]
...
+
image:configuring_link_costs.png["Coût des liens"]
...
+
Pour annuler les modifications, sélectionnez image:nms_revert.gif["icône annuler"]*Revert*.
