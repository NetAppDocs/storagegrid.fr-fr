...
summary: 'StorageGRID utilise une autorité de certification (CA) interne pour sécuriser le trafic interne. Ce certificat ne change pas si vous importez vos propres certificats.' 
---
