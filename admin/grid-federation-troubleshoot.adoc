...
+
image:grid-federation-retry-account-clone.png["Capture d'écran affichant un message d'erreur et le bouton Réessayer le clone de compte"]Si l'erreur a été résolue, le compte du locataire sera maintenant cloné sur l'autre grille.
...
image:grid-federation-last-error.png["Capture d'écran affichant un message dans la colonne dernière erreur d'une connexion de fédération de grille"]
