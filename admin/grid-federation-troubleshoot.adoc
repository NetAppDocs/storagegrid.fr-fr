...
* Les paramètres de verrouillage d'objet S3 de l'objet source ne sont pas conformes aux paramètres de conservation au niveau du locataire de la grille de destination.
