...
+
image:grid-federation-tenant-detail.png["onglet grid federation de la page de détails du locataire"]
...
image:grid-federation-remove-permission.png["procédure de suppression de la connexion de fédération de grille"]
...
+
image:grid-federation-remove-permission-error.png["message d'erreur affiché si cgr est activé pour un compartiment pour le tenant"]
