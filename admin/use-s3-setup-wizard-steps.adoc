...
** Sélectionnez l'icône de copie (image:icon_tenant_copy_url.png["icône copier"]) pour copier l'ID de clé d'accès et la clé d'accès secrète dans le presse-papiers.
