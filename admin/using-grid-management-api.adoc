...
.Étapes
. Dans l'en-tête de Grid Manager, sélectionnez l'icône d'aide image:icon_help_menu_bar.png["Icône d'aide"] et sélectionnez *Documentation API*.
...
+
image:swagger_example.png["Exemple de l'interface utilisateur de swagger"]
