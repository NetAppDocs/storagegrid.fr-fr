...
NOTE: Nécessite un accès au port 22 entre l'ordinateur portable de service et tous les autres nœuds du réseau.  Supprimez l'accès au port 22 une fois la tâche de maintenance terminée.
