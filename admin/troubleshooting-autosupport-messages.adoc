...
summary: 'Si une tentative d"envoi d"un package AutoSupport échoue, le système StorageGRID prend différentes mesures selon le type de package AutoSupport.' 
---
