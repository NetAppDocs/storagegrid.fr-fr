...
---
= Créez des connexions de fournisseur de services dans PingFederate pour SAML dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Utilisez PingFederate pour créer une connexion de fournisseur de services (SP) pour chaque nœud d'administration pour SAML dans votre système. Pour accélérer le processus, vous importerez les métadonnées SAML depuis StorageGRID.
