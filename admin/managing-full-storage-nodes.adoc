...
summary: 'Lorsque les nœuds de stockage atteignent leur capacité, vous devez étendre le système StorageGRID en ajoutant de nouveaux espaces de stockage. Trois options s"offrent à vous : ajouter des volumes de stockage, ajouter des étagères d"extension de stockage ou ajouter des nœuds de stockage.' 
---
