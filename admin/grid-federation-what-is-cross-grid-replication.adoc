...
image:grid-federation-cgr-workflow.png["Flux de production de réplication entre les grilles"]
...
image:grid-federation-cross-grid-replication-one-direction.png["image montrant la connexion de fédération de grille dans une direction"]
...
image:grid-federation-cross-grid-replication.png["image montrant la réplication dans une direction par rapport à la réplication dans les deux directions"]
...
image:grid-federation-cross-grid-replication-delete.png["image montrant la suppression du client répliqué sur les deux grilles"]
