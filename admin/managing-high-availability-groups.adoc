...
summary: Les groupes haute disponibilité proposent des connexions de données extrêmement disponibles pour les clients S3 et des connexions extrêmement disponibles pour Grid Manager et tenant Manager. 
---
...
image:ha_group_primary_interface.png["Interface principale du groupe HAUTE DISPONIBILITÉ"]
