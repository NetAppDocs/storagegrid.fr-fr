...
summary: 'Avant de configurer un serveur de gestion des clés externe (KMS), vous devez connaître les considérations et les exigences requises.' 
---
...
image:kms_per_site.png["KILOMÈTRES PAR site"]
