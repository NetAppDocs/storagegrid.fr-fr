...
summary: 'Un serveur de gestion de clés (KMS) est un système externe tiers qui fournit des clés de chiffrement aux nœuds d"appliance StorageGRID sur le site StorageGRID associé en utilisant le protocole d"interopérabilité de gestion de clés (KMIP)' 
---
