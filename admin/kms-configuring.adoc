...
summary: 'Un serveur de gestion des clés (KMS) est un système externe tiers qui fournit des clés de chiffrement aux nœuds d"appliance StorageGRID sur le site StorageGRID associé à l"aide du protocole KMIP (Key Management Interoperability Protocol).' 
---
