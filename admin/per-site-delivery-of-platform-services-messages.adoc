...
image:notification_multiple_sites.gif["Le schéma montrant cette action sur l'objet du site 1 déclenche la notification du site 1"]
...
image:notifications_site_2.gif["le schéma montrant l'action sur l'objet du site 2 déclenche les notifications du site 2"]
