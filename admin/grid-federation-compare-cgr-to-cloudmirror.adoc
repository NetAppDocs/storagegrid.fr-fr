...
---
= Comparer la réplication inter-grilles et la réplication CloudMirror dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Ajoutez de nouveaux comptes locataires, qui sont automatiquement synchronisés avec l'autre grid.
. Ajoutez de nouveaux groupes de locataires et utilisateurs, qui sont également synchronisés.
