...
image:tenant_dashboard_with_buckets.png["Tableau de bord - liste des compartiments"]
...
+
image:tenant_dashboard_storage_usage_segment.png["Segment de diagramme à barres"]
...
+
image:tenant_dashboard_buckets.png["Compartiments du tableau de bord des locataires"]
...
image:tenant_dashboard_endpoint_error.png["Tableau de bord affichant le message de point final"]
