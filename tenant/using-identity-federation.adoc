...
image:tenant_shares_identity_federation.png["Le locataire partage la fédération des identités"]
...
+
image:ldap_service_type.png["Page Fédération des identités affichant les options de type de service LDAP"]
...
+
image:identity_federation_test_connection.png["Invite de fédération des identités pour valider le format du nom d'utilisateur de liaison"]
