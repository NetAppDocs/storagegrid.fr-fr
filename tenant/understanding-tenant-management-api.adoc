...
* *configurations s3* : opérations permettant de récupérer les configurations globales S3.
...
image:tenant_api_swagger_example.gif["Exemple d'opération D'OBTENTION de groupes dans l'API swagger"]
