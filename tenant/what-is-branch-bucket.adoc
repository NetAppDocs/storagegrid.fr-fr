...
* Vous enregistrez des données dans un compartiment versionné. Une vulnérabilité accidentelle a entraîné l'ingestion de nombreux objets indésirables entre les instants _T1_ et _T2_. Vous pouvez créer un compartiment de branche pour les valeurs temporelles _Exclude_, _T1_ et _T2_, et rediriger les opérations client vers ce compartiment de branche. Ainsi, seuls les objets ingérés avant _T1_ et après _T2_ sont exposés aux clients.
...
Voir aussi link:../ilm/how-objects-and-delete-markers-are-deleted.html#delete-s3-versioned-objects["Suppression d'objets avec version S3"].
