...
+
image:delete-bucket-objects-in-progress.png["capture d'écran montrant la suppression d'objets de compartiment"]
...
+
image:delete-bucket-objects-complete.png["capture d'écran montrant tous les objets de compartiment supprimés"]
