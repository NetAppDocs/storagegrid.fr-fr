...
|===
--
.Points de terminaison Webhook et Kafka
--
Vérifiez la connexion TLS pour les points de terminaison webhook ou Kafka.
...
*Remarque* : Les points de terminaison Webhook ne disposent pas de cette option.
