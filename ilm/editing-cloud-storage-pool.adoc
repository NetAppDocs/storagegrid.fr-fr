...
summary: 'Vous pouvez modifier un pool de stockage cloud pour en changer le nom, le point de terminaison de service ou d"autres détails. Cependant, vous ne pouvez pas modifier le compartiment S3 ni le conteneur Azure pour un pool de stockage cloud.' 
---
= Modifier un Cloud Storage Pool dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
