...
summary: 'Vous pouvez modifier un pool de stockage cloud pour en changer le nom, le point de terminaison de service ou d"autres détails ; toutefois, vous ne pouvez pas changer le compartiment S3 ou le conteneur Azure pour un pool de stockage cloud.' 
---
