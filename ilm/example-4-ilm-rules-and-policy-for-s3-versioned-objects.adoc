...
---
= Règles et politiques ILM pour les versions non actuelles des objets S3 dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:ilm_rule_apply_only_to_older_object_verions.png["Appliquer la règle ILM uniquement aux versions d'objets plus anciennes (heure non actuelle)"]
...
link:how-objects-and-delete-markers-are-deleted.html["Comment les objets et les marqueurs de suppression sont supprimés"]
