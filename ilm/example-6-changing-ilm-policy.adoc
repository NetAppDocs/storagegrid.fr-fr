...
---
= Comment la modification d'une politique ILM affecte les performances de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:policy_6_active_policy.png["Exemple de règle ILM 6 règle active"]
