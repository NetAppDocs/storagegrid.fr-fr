...
summary: Un pool de stockage cloud spécifie un seul compartiment Amazon S3 externe, un autre fournisseur compatible S3 ou un conteneur Azure Blob Storage. 
---
