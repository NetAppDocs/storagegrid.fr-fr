...
---
= Règles ILM et politique pour le filtrage de la taille des objets EC dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
|===
image:policy_2_rule_1_ec_objects_adv_filtering.png["Règle ILM 1, par exemple 2 : utilise ce pour tous les objets de plus de 1 Mo"]
