...
summary: 'Lorsque vous créez une règle ILM, vous spécifiez l"une des trois options suivantes pour protéger les objets lors de l"ingestion : Dual commit, Strict ou Balanced.' 
---
