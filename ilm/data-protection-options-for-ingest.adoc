...
summary: 'Lorsque vous créez une règle ILM, vous pouvez protéger les objets lors de l"ingestion en spécifiant soit Dual commit, Strict, ou Balanced.' 
---
= Options d'ingestion ILM dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:ingest_object_lifecycle.png["Diagramme montrant comment l'ingestion d'objet se produit pour chaque option d'ingestion"]
