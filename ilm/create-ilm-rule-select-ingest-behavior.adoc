...
summary: 'L"étape 3 (Sélection du comportement d"ingestion) de l"assistant Create ILM Rule vous permet de choisir comment les objets filtrés par cette règle sont protégés lors de leur ingestion.' 
---
= Sélectionnez le comportement d'ingestion pour une règle ILM StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
