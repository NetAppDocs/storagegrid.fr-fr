...
---
= Découvrez le code d'effacement dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:ec_three_sites_4_plus_2.png["Codage d'effacement sur trois sites 4 plus 2"]
...
image:ec_recoverable_4_plus_2.png["Codage d'effacement récupérable 4 plus 2"]

Si plus de deux nœuds de stockage sont perdus, l'objet n'est pas récupérable.

image:ec_unrecoverable_4_plus_2.png["Codage d'effacement irrécupérable 4 plus 2"]
