...
---
= Exemples de simulations de stratégies ILM dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:simulate_policy_screen.png["Simuler les résultats de la règle"]
...
+
image:simulate_reorder_rules_pngs_result.png["Exemple 2 : réorganisation des règles lors de la simulation d'une politique ILM"]
...
+
image:simulate_reorder_rules_correct_result.png["Exemple 2 : réorganisation des règles lors de la simulation d'une politique ILM"]
...
image:simulate_results_for_object_wrong_metadata.png["Exemple 3 : correction d'une règle lors de la simulation d'une règle ILM"]
...
+
image:simulate_results_for_object_corrected_metadata.png["Exemple 3 : correction d'une règle lors de la simulation d'une règle ILM"]
