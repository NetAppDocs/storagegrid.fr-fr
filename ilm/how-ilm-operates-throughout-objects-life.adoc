...
---
= Fonctionnement de l'ILM tout au long du cycle de vie d'un objet dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:overview_of_object_lifecycle.png["Présentation du cycle de vie des objets"]
