...
---
= Créez et attribuez des niveaux de stockage dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
.. Pour chaque niveau de stockage personnalisé que vous souhaitez ajouter, sélectionnez *Insérer* image:icon_nms_insert.gif["insérer l'icône"] pour ajouter une ligne.
.. Saisissez un libellé descriptif.
+
image:editing_storage_grades.gif["Notes de stockage"]

.. Sélectionnez *appliquer les modifications*.
.. Si vous devez modifier une étiquette enregistrée, sélectionnez *Modifier* image:icon_nms_edit.gif["icône modifier"] et sélectionnez *Appliquer les modifications*.
+
...
+
.. Repérez le nœud de stockage dans la liste LDR et sélectionnez son icône *Modifier* image:icon_nms_edit.gif["icône modifier"].
.. Sélectionnez le niveau de stockage approprié dans la liste.
+
image:assigning_storage_grades_to_storage_nodes.gif["Notes de stockage"]
