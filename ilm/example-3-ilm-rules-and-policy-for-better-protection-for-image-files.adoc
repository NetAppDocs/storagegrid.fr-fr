...
---
= Règles et politique ILM pour la protection des fichiers image dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
|===
image:policy_3_rule_1_ec_images_adv_filtering.png["Règle ILM 1 par exemple 3 : utilisez EC pour les fichiers image de plus de 1 Mo"]
...
image:policy_3_configured_policy.png["Règle ILM, par exemple 3 : meilleure protection des fichiers image"]
