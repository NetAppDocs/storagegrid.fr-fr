...
---
= Travaillez avec les règles ILM et les politiques ILM dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:ilm_rule_details_page.png["Page de détails des règles ILM"]
...
+
Vous pouvez sélectionner le point d'interrogation image:icon_nms_question.png["icône point d'interrogation"] pour afficher une description des éléments de l'onglet ILM.

+
image:ilm_metrics_on_dashboard.png["Metrics ILM sur le tableau de bord Grid Manager"]
