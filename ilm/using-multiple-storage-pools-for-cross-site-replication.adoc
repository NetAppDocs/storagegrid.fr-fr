...
CAUTION: Lors de la configuration de votre déploiement StorageGRID pour la protection contre les pertes de site, vous devez également prendre en compte les effets link:data-protection-options-for-ingest.html["options d'ingestion"]de et link:../s3/consistency.html["la cohérence"].
