...
summary: 'Une règle de gestion du cycle de vie des informations (ILM) est un ensemble ordonné de règles ILM qui détermine la façon dont le système StorageGRID gère les données d"objet au fil du temps.' 
---
= Découvrez les politiques ILM dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:ilm_policies_single.png["Diagramme de règles ILM uniques"]
...
image:ilm_policies_tags_conceptual.png["Diagramme de règles ILM multiples"]
...
image:ilm_policy_and_rules.png["Règles et règles ILM"]
