...
---
= Règles et politiques ILM pour un comportement d'ingestion strict dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
|===
image:ilm_rule_1_example_5_strict_ingest.png["Règle ILM 1 exemple 5 ingestion stricte"]
