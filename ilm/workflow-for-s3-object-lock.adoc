...
---
= Workflow de verrouillage d'objet S3 dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Apprenez-en plus sur link:requirements-for-s3-object-lock.html#s3-object-lock-existing-buckets["Exigences de verrouillage d'objet S3"]
