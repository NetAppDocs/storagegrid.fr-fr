...
---
= Saisissez les détails et les filtres d'une règle ILM StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:advanced_filtering_size_between.png["Exemple de filtrage avancé pour la taille d'objet"]
...
image:advanced_filtering_multiple_rows.png["Exemple de filtrage avancé pour les métadonnées utilisateur"]
