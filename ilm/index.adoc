...
summary: 'Les règles de gestion du cycle de vie des informations (ILM) indiquent à StorageGRID comment créer et distribuer des copies de données en mode objet et comment gérer ces copies au fil du temps.' 
---
= Gérez les objets avec ILM dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
