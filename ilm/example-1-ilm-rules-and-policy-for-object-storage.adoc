...
---
= Règles ILM et politique pour la protection et la conservation de base des objets dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:ilm_rule_two_copies_two_data_centers.png["Règle ILM 1, exemple 1 : copie des données d'objet vers deux sites"]
...
|===
image:ilm_rule_ec_for_s3_bucket_finance_records.png["Règle ILM 2, exemple 1 : profil de code d'effacement avec mise en correspondance des compartiments"]
...
+
image:policy_1_configured_policy.png["Règle ILM, par exemple 1"]
