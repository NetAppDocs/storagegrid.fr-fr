...
---
= Surveiller les connexions de fédération de grille StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:grid-federation-connections-tab.png["Onglet Grid federation Connections"]
...
+
image:grid-federation-permitted-tenants-tab.png["Onglet Grid federation permis tenants"]
...
+
image:grid-federation-permitted-tenants-tab-for-connection.png["grid-federation-permit-tenants-tab-for-connection"]
...
+
image:grid-federation-certificates-tab.png["onglet-certificats-fédération-grid"]
