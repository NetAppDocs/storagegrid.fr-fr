...
+
image:grid_federation_connections_tab.png["Onglet Grid federation Connections"]
...
+
image:grid_federation_permitted_tenants_tab.png["Onglet Grid federation permis tenants"]
...
+
image:grid_federation_permitted_tenants_tab_for_connection.png["grid-federation-permit-tenants-tab-for-connection"]
...
+
image:grid_federation_certificates_tab.png["onglet-certificats-fédération-grid"]
