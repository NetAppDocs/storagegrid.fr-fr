...
+
Sélectionnez l'icône plus image:icon_plus_sign_black_on_white.gif["icône plus"] pour ajouter des destinataires.
...
NOTE: Si vous devez modifier les paramètres de messagerie, sélectionnez l'icône en forme de crayon image:icon_edit_tm.png["Icône Modifier"] pour mettre à jour ce champ.
