...
+
image:nodes_page_hardware_tab_for_appliance.png["Page noeuds onglet matériel de l'appliance"]
...
+
image:nodes_page_network_communication.png["Nœuds page réseau Comm"]
...
+
image:nodes_page_storage_tables.png["Nœuds tables de stockage des pages"]
...
+
image:nodes_page_hardware_tab_services_appliance.png["Page noeuds onglet matériel de l'appliance de services"]
...
.. Consultez la section interfaces réseau.
+
image:nodes_page_hardware_tab_network_services_appliance.png["Page noeuds onglet matériel serveur de services réseau"]
...
+
image:nodes_page_storage_tab_services_appliance.png["Nœuds page stockage onglet Services Appliance"]
