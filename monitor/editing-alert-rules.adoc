...
+
image:alert_rules_edit_rule.png["Alertes > Modifier la règle"]
...
+
image:alert_rules_edit_revert_to_default.png["Règles d'alerte : rétablissement d'une condition modifiée en valeur par défaut"]
