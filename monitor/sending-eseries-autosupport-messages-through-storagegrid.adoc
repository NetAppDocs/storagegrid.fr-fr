...
* Vous avez le link:../admin/admin-group-permissions.html["Administrateur de l'appliance de stockage ou autorisation d'accès racine"].
...
+
image:autosupport_santricity_home_page.png["Page d'accueil de AutoSupport SANtricity"]
...
+
image:autosupport_santricity_operations.png["Opérations AutoSupport SANtricity AutoSupport"]
...
+
image:autosupport_configure_delivery_santricity.png["AutoSupport configure la méthode de livraison AutoSupport SANtricity"]
