...
+
image:alerts_create_custom_rule.png["Alertes > Créer une règle personnalisée"]
...
+
Pour consulter les indicateurs disponibles et tester les expressions Prometheus, sélectionnez l'icône d'aide image:icon_nms_question.png["icône point d'interrogation"] et suivez le lien vers la section Metrics de l'API de gestion de la grille.
