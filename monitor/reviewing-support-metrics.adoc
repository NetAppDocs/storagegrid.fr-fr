...
---
= Examiner les indicateurs de support StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:metrics_page.png["Page mesures"]

. Pour consulter les valeurs actuelles des indicateurs StorageGRID et visualiser les graphiques de ces valeurs au fil du temps, sélectionnez le lien dans la section Prometheus.
+
...
. Pour accéder aux tableaux de bord préconfigurés contenant des graphiques des métriques StorageGRID au fil du temps, sélectionnez les liens dans la section Grafana.
+
