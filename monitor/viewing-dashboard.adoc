...
---
= Consultez et gérez le tableau de bord dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:grid_manager_dashboard.png["Tableau de bord de Grid Manager"]
...
|===
Certaines cartes peuvent être agrandies pour une meilleure lisibilité. Sélectionnez l’icône d’agrandissement image:icon_dashboard_card_maximize.png["Icône Agrandir"] dans le coin supérieur droit de la carte. Pour fermer une carte agrandie, sélectionnez l’icône de réduction image:icon_dashboard_card_minimize.png["Icône réduire"] ou sélectionnez *Fermer*.
...
image:dashboard_manage.png["Gestion des tableaux de bord"]
...
image:dashboard_configure.png["Configurer le tableau de bord"]
