...
sidebar: sidebar 
keywords: ilm tab 
summary: 'L"onglet ILM fournit des informations sur les opérations de gestion du cycle de vie de l"information (ILM).' 
---
= Affichez l’onglet StorageGRID ILM
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:nodes_page_ilm_tab.png["Onglet ILM de la page nœuds"]
