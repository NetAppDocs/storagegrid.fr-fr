...
---
= Consultez l'onglet Services de la plateforme StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:nodes_page_site_level_platform_services.gif["Nœuds page des services de plateforme au niveau du site"]
