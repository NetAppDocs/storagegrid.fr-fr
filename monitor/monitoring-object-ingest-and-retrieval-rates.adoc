...
---
= Surveillez les opérations du client S3 dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:nodes_storage_node_objects_help.png["Capture d'écran de Nodes > _Storage Node_ > Objects > aide sur les attributs"]
