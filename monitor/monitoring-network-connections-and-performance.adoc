...
---
= Surveillez les ressources réseau et système dans StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:nodes_menu.png["Menu noeuds"]
...
+
image:traffic_classification_policies_main_screen_w_examples.png["Politique de trafic pour un exemple de graphique"]

.. Pour afficher les graphiques présentant les indicateurs de réseau associés à une politique, sélectionnez le bouton radio situé à gauche de la politique, puis sélectionnez *Metrics*.
