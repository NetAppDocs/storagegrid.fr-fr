...
Pour plus de détails sur la syntaxe des requêtes Prometheus, voir https://prometheus.io/docs/prometheus/latest/querying/basics/["Principes de base des requêtes"^].
...
+
image:nodes_page_network_traffic_graph.png["Graphique Prometheus"]
