...
---
= Affichez l’onglet SANtricity System Manager de StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Pour utiliser SANtricity System Manager afin de configurer un proxy pour E-Series AutoSupport, consultez link:sending-eseries-autosupport-messages-through-storagegrid.html["Envoyez des packages AutoSupport E-Series via StorageGRID"].
...
image:nodes_page_santricity_tab.png["Onglet SANtricity de la page nœuds"]
