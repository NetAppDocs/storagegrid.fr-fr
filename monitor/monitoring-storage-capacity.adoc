...
NOTE: Pour visualiser les graphiques de ces valeurs, sélectionnez les icônes de graphique dans les colonnes disponibles.
...
image:forecast_metadata_usage.png["Prévision de l'utilisation des métadonnées par site"]
